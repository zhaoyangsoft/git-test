...
.push([
	["app"], {
		...
		4360: function(e, t, n) {
			...
			var A = function(e) {
					return function(t) {
						return Promise.all([n.e("chunk-489f3c0e"), n.e("chunk-89554882"), n.e("chunk-2d0d6345"), n.e("chunk-2d0e2366"), n.e("chunk-0c2d28a0")])
							.then(function() {
			...
			function fe(e, t) {
				for (var n = {}, a = {}, i = 0; i < e.length; i++) {
					var r = e[i],
						...
						u = r.content || r.notes,
						d = r.evidence_info && r.evidence_info.refund_ids ? r.evidence_info.refund_ids : [],
						l = ce["MESSAGE_TYPE"].MESSAGE;
					if (r.time_posted === t || r.date === t) {
						var f = r.notes || r.content;
						f && (a.notes = f), r.time_posted && (a.documents = r.documents), r.dispute_life_cycle_stage = ce["DISPUTE_LIFE_CYCLE_STAGE"].INQUIRY
					}
					s && (l = ce["MESSAGE_TYPE"].TRACKING_INFO), r.action_info && r.action_info.response_option === ce["MESSAGE_TYPE"].REFUND && (l = ce["MESSAGE_TYPE"].REFUND), r.provided_time && (l = ce["MESSAGE_TYPE"].SUPPORTING_INFO, r.dispute_life_cycle_stage = ce["DISPUTE_LIFE_CYCLE_STAGE"].CHARGEBACK), d.length > 0 && (l = ce["MESSAGE_TYPE"].REFUND_INFO), r.event_type !== ce["MESSAGE_TYPE"].PROPOSED && r.event_type !== ce["MESSAGE_TYPE"].DENIED && r.event_type !== ce["MESSAGE_TYPE"].ACCEPTED || (l = r.event_type), n[o] ? (u && !n[o].content && (n[o].content = u), r.documents && !n[o].documents && (n[o].documents = r.documents), r.offer_amount && !n[o].offer_amount && (n[o].offer_amount = r.offer_amount), r.trackInfo && !n[o].trackInfo && (n[o].trackInfo = r.trackInfo), r.dispute_life_cycle_stage && (n[o].dispute_life_cycle_stage = r.dispute_life_cycle_stage), d && (n[o].refund_info = d), r.offer_type && (n[o].offer_type = r.offer_type), n[o].event_type = l) : n[o] = {
						content: u,

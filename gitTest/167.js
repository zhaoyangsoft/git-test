...
.push([
	["app"], {
		...
		4360: function(e, t, n) {
			...
			var A = function(e) {
					return function(t) {
						return Promise.all([n.e("chunk-5355ceef"), n.e("chunk-89554882"), n.e("chunk-2d0d6345"), n.e("chunk-2d0e2366"), n.e("chunk-d1b62776")])
							.then(function() {
		...
		c1f7: function(e, t, n) {
			...
			function Re(e) {
				if (e && e instanceof Array && e.length > 0) {
					var t = Me["a"].getters && Me["a"].getters.permissions,
						n = e,
						a = t.some((function(e) {
							return n.includes(e)
						}));
			...
			var ze, Pe, Ne = n("bc3a"),
				...
				zt = Rt,
				Pt = Object(l["a"])(zt, It, Mt, !1, null, null, null),
				Nt = Pt.exports,
				jt = {
					computed: {
						device: function() {
				...
				mn = {
					watch: {
						$route: function(e) {
							"mobile" === this.device && this.sidebar.opened && Me["a"].dispatch("app/closeSideBar", {
								withoutAnimation: !1
							})
						}
					},
					...
					mounted: function() {
						...
						e && (Me["a"].dispatch("app/toggleDevice", "mobile"), Me["a"].dispatch("app/closeSideBar", {
							withoutAnimation: !0
						}))
					},
					methods: {
						...
						$_resizeHandler: function() {
							if (!document.hidden) {
								var e = this.$_isMobile();
								Me["a"].dispatch("app/toggleDevice", e ? "mobile" : "desktop"), e && Me["a"].dispatch("app/closeSideBar", {
									withoutAnimation: !0
								})
							}
						}

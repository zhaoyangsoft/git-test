(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["app"], {
    ...
    4360: function(e, t, n) {
        ...
        var z = function(e) {
            return function(t) {
                return Promise.all([n.e("chunk-2fff81d6"), n.e("chunk-38788fe3"), n.e("chunk-2d0d6345"), n.e("chunk-2d0e2366"), n.e("chunk-7331570e")]).then(function() {
    ...
    "56d7": function(e, t, n) {
        ...
        var Be = Te
          ...
          , Ne = {
            inserted: function(e, t) {
                ...
                c && (e["data-layoutDom"] = document.querySelector("#" + c));
                var u = null;
                e.className;
                e["data-oldClassName"] = e.className,
                e.className;
                var d = "beforeFixedDom-" + Math.round(1e3 * Math.random()) + "-" + Math.round(1e3 * Math.random())
                  , l = "<div id=".concat(d, "></div>");
                ...
                e["data-docScrollFixed"] = function() {
                    u || (u = setTimeout((function() {
                        ...
                        if (t) {
                            ...
                            switch (n) {
                            case "top":
                                a >= 0 ? e.className = e["data-oldClassName"] : (e.className = e["data-oldClassName"] + " " + Re,
                                e.style.top = "".concat(r || 0, "px"));
                                break;
                            case "bottom":
                                a <= We() + 10 ? e.className = e["data-oldClassName"] : (e.className = e["data-oldClassName"] + " " + $e,
                ...
                ,
                s.addEventListener("scroll", e["data-docScrollFixed"])
            },
            update: function(e, t) {
                var n = t.arg;
                if (e["data-oldClassName"]) {
                    ...
                    if (i) {
                        ...
                        a["default"].nextTick((function() {
                            switch (n) {
                            case "top":
                                e.className = r >= 0 ? e["data-oldClassName"] : e["data-oldClassName"] + " " + Re;
                                break;
                            case "bottom":
                                r <= o ? e.className = e["data-oldClassName"] : (e.className = e["data-oldClassName"] + " " + $e,
                                e["data-layoutDom"] && (e.style.width = e["data-layoutDom"].scrollWidth + "px"));
                                break;
                            default:
                                break
        ...
        a["default"].component("barcode", Ke.a),
        a["default"].directive("scrollBottom", Fe),
        a["default"].directive("domFixed", Ne),
        a["default"].directive("copy", Ge),
        ...
        a["default"].prototype.$getNowDate = Qe["a"],
    ...
    a18c: function(e, t, n) {
        ...
        var o = [{
            ...
            children: [{
                path: "index",
                component: function(e) {
                    return Promise.all([n.e("chunk-2fff81d6"), n.e("chunk-f30526c8")]).then(function() {
                        var t = [n("1e4b")];
                        e.apply(null, t)
                    }
                    .bind(this)).catch(n.oe)
    ...
    a5d9: function(e, t, n) {
        ...
        n("aecd"))
          ...
          , c = o
          , s = n("2877")
          , u = Object(s["a"])(c, a, i, !1, null, "16ea5c3c", null);
        t["a"] = u.exports
    },
    a601: function(e, t, n) {
        "use strict";
    ...
    c1f7: function(e, t, n) {
        ...
        n("44ef"))
          ...
          , Ve = Oe
          , ke = (n("0e94"),
        Object(l["a"])(Ve, ge, be, !1, null, "46ee93ed", null))
          , Le = ke.exports
          , Ce = function() {
            var e = this
              , t = e.$createElement
                    ...
                    if ("debug" !== e) {
                        ...
                        Be.a.post("".concat("/prod-api", "/resource/timerRemindAll"), a, i).then((function(e) {
                            if (!(200 !== e.status || e.data.code && 200 !== e.data.code)) {
                                ...
                                n.orderRemindData) {
                                    var O = JSON.parse(n.orderRemindData)
                                      , V = O.data;
                                    V.notMatchedData && t.notice.push({
                                        title: "已入云仓快递",
                                        nums: V.notMatchedData,
                                        path: "/order/notmatched",
                                        query: {
                                            status: 0
                                        }
                                    }),
                                    V.rewardData && t.notice.push({
                                        title: "打赏给我",
                                        nums: V.rewardData,
                                        path: "/order/reward",
                                        query: {
                                ...
                                t.walletIconInfo = [],
                                n.orderRemindData) {
                                    var k = JSON.parse(n.orderRemindData)
                                      , L = k.data
                                      , C = L.auditData
                                      , z = L.platformAuditData;
                                    if (C) {
                                        var S = []
                                          , M = function(e) {
                                    ...
                                    if (z) {
                                        ...
                                        for (var _ in z)
                                            j(_);
                                        E.length > 0 && t.walletIconInfo.push({
                                            title: "平台审核",
                                            children: E
                                        })
                                    }
                                ...
                                l || f || o) {
                                    ...
                                    H.length && t.walletIconInfo.push({
                                        title: "包裹审核",
                                        children: H
                                    })
                                }
                                ...
                                n.orderRemindData) {
                                    var T = JSON.parse(n.orderRemindData)
                                      , B = T.data.limitRemindData;
                                    B && t.lightBulbRemindList.push({
                                        title: "邮限提醒",
                                        content: B,
                                        query: {}
                                    })
                                ...
                                if (n.resRemindData) {
                                    var I = JSON.parse(n.resRemindData).data
                                      , P = I.remindData
                                      , D = I.postingAcceptData
                                      , R = I.postingAuditData;
                                ...
                                n.orderRemindData) {
                                    var X = JSON.parse(n.orderRemindData)
                                      , ee = X.data.itemNotifyData;
                                    if (ee) {
                                        var te = [];
                                        for (var ne in ee)
                                            switch (ne) {
                                        ...
                                        te.length > 0 && t.messageList.push({
                                            title: "待确认完成",
                                            children: te
                                        })
                                    }
                                ...
                                if (n.storageTimerRemind) {
                                    var ae = JSON.parse(n.storageTimerRemind)
                                      , ie = ae.data
                                      , re = ie.insurance
                                      , oe = ie.insuranceAudit
                                      , ce = {
                                        title: "保险",
                                        children: []
                                    };
                                    ...
                                    ce.children.length > 0 && t.messageList.push(ce)
                                }
                            }
                        }
                        ))
        ...
        Object(l["a"])(De, Ce, ze, !1, null, "cb08a424", null)), $e = Re.exports, Ne = {
            components: {
                Breadcrumb: I,
                Hamburger: W,
                Screenfull: Z,
        ...
        Object(l["a"])(We, L, C, !1, null, "7113e544", null)), Ge = Fe.exports, Ue = function() {
            var e = this
              , t = e.$createElement
              , n = e._self._c || t;
            return n("div", {
    ...
    d774: function(e, t, n) {
        ...
        var a = {
          ...
          , d = [-1, 0, 10, 11, 12, 20, 21, 24, 28, 29, 30, 31, 33, 34, 37, 50]
    },
    d7a0: function(e, t, n) {
        "use strict";
        n.r(t);
        ...
        function l(e) {
            ...
            try {
                ...
                aa.then(res=>{
                    ...
                    let pd_items = localStorage.getItem('pd_items');
                    // pd_items {orderId: items[]}
                    let orderNum = getQueryString('purchaseNo');
                    if(pd_items==null){
                    ...
                    let temp_items = localStorage.getItem('pd_items');
                    temp_items = JSON.parse(temp_items);
                    console.log('当前采集', temp_items.length);
                 })
            } catch (error) {
